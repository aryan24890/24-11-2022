 ...
 ***********************************************************************/
			...
			c1.setDescription("Soft drinks, coffees, teas, beers, and ales");
			...
			//getByName()
			Category cat2 = categoryDAO.getByName("Beverages");
			System.out.println("Category by name :" + cat2); 
			
			//getByNames()
			List<Category> cList2 = categoryDAO.getByNames("Dairy");
...
***********************************************************************/			
			...
			//get discontinued products	 method	
